...
const SCENARIO_DRAWS_PER_BUCKET = 4000;
...
const STRATEGY_SCREENING_DRAWS_PER_BUCKET = 12;
const SCREENING_EARLY_PCT_POINT_COUNT = 4;
const SCREENING_LATER_PCT_POINT_COUNT = 4;
const SCREENING_SECOND_YEAR_POINT_COUNT = 5;
const SCREENING_SECOND_MORTGAGE_POINT_COUNT = 4;
const FINAL_OVERALL_CANDIDATES_PER_OBJECTIVE = 28;
const FINAL_PATH_CANDIDATES_PER_OBJECTIVE = 14;
const EXPLICIT_GRID_TOP_ONE_HOME_PER_CELL = 4;
const EXPLICIT_GRID_TOP_TWO_HOME_PER_CELL = 5;
...
const reportJson = {
  ...
  meta: {
    ...
    scenarioSampling: {
      ...
      bucketCount: OPTIMIZER_INCOME_CASES.length * OPTIMIZER_MARKET_CASES.length * 2,
    ...
    strategySampling: {
      ...
      screeningScenarioCount: screeningScenarios.length,
      screeningEvaluationCount: strategyGrid.explicitCandidateCount * screeningScenarios.length,
      screenedToCandidateCount: selectionSummary.selectedCandidateCount,
      fullEvaluationCount: selectionSummary.selectedCandidateCount * scenarios.length,
